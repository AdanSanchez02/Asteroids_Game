...
window.requestAnimFrame = (function(){
  ...
  let GameEngine = function(canvasSelector, scoreSelector) {
		  ...
		  if (typeof(Storage) !== "undefined") {
			  localStorage["board.0.name"] = "Juanito Banans";
			  localStorage["board.0.score"] = 0017;
			  localStorage["board.1.name"] = "Tanjiro";
			  localStorage["board.1.score"] = 1207;
		  }
  ...
  var Polygon = function (options) {
		  ...
		  p.Draw = function(ctx) {
			  ...
			  // Draw this object 4 times to simulate 
			  ctx.save();
